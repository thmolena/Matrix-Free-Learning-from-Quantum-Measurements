#!/usr/bin/env python
"""Run a single experiment at FULL config, writing into submission/{figures,tables}.

Usage: python run_one.py <exp1|exp2|exp3|exp4|exp5> [n_threads]
...
cfg['figures_dir'] = os.path.join(project_root, 'figures')
cfg['tables_dir'] = os.path.join(project_root, 'tables')
