#!/usr/bin/env python3
"""Fetch and authenticate the original data for Matrix-Free Learning of Open Quantum Systems from Measured Signals."""
...
BASE_COMMAND = ["cptppinn-fetch-real-data","--output","/tmp/ramsey_zenodo15797402.csv"]
